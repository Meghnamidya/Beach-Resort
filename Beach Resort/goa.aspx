<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="goa.aspx.cs" Inherits="Beach_Resort.WebForm22" %>
			...
			<div class="box">
				<div>
					<div class="body">
						...
						<p style="text-transform:capitalize; text-align:center;"><b>IMMERSE YOURSELF IN THE 5-STAR LUXURY OF OUR GOA HOTEL</b></p>
						<p style="text-align:justify">The best and most luxurious getaway in Goa, Beach Resort is nestled just within the shoreline and offers all that is needed to make your holiday delightful, starry-eyed, and posh. It is one of the most luxurious resorts in Goa that offers an unmatched beauty of the marine horizon and grandeur of the century-old Portuguese Fort.</p>
						<p style="text-align:justify">Visit the hotel to cherish surreal hotel landscape comprising of palms, antiquated trails, world class cottages & rooms, and the best dining experience by the Beach Resort.</p>
						<br />
						<div style="margin-right:2%;">
							<div class="slideshow-container">
								<div class="mySlides fade">
									<div class="numbertext">1 / 5</div>
									<img src="images/goa1.jpg" style="width:100%;height:400px">
								</div>
								<div class="mySlides fade">
									<div class="numbertext">2 / 5</div>
									<img src="images/goa2.jpg" style="width:100%;height:400px">
								</div>
								<div class="mySlides fade">
									<div class="numbertext">3 / 5</div>
									<img src="images/goa3.jpg" style="width:100%;height:400px">
								</div>
								<div class="mySlides fade">
									<div class="numbertext">4 / 5</div>
									<img src="images/goa4.jpg" style="width:100%;height:400px">
								</div>
								<div class="mySlides fade">
									<div class="numbertext">5 / 5</div>
									<img src="images/goa5.jpg" style="width:100%;height:400px">
								</div>
